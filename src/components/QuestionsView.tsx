        ...
        <div className="bg-[#111827] rounded-xl border border-[#1E293B] shadow-2xl overflow-hidden">
          ...
          <div className="divide-y divide-[#1E293B] p-5 space-y-5">
            {currentPageData.questions.map((question, qIdx) => {
              ...
              const aiProposal = aiProposalAnswers.find((a) => a.questionId === question.id);
              const formatAnswer = (item?: QuestionAnswer) => {
                if (!item) return 'N/A';
                if (item.textResponse) return item.textResponse;
                ...
                return values.map(value => {
                  ...
                  return option ? `${option.label} (value: ${value})` : value;
                }).join(', ') || 'N/A';
              };
              ...
              return (
                ...
                >
                  ...
                  <div className="ml-8.5 pl-0 sm:pl-1 space-y-2">
                    ...
                    {aiProposal && (
                      <div className="mt-3 bg-purple-950/20 border border-purple-500/50 rounded-lg p-3.5 text-xs font-mono shadow-md">
                        <div className="flex items-center justify-between pb-2 mb-2 border-b border-purple-900/60">
                          ...
                          <span className="px-2 py-0.5 rounded bg-purple-950 text-purple-200 border border-purple-700 text-[11px] font-bold">
                            BEFORE SERVER APPLY
                          </span>
                        </div>
                        <div className="text-purple-100">
                          ...
                          <span className="font-bold underline">
                            {formatAnswer(aiProposal)}
                          </span>
                        </div>
                        {aiProposal.reasoning && (
                          <div className="mt-2 text-slate-300 text-[10px] leading-relaxed">
                            <span className="text-purple-300 font-bold">AI reasoning:</span>{' '}
                            {aiProposal.reasoning}
                          </div>
                        )}
                      </div>
                      ...
                      <div className="mt-3 bg-[#030712] border border-emerald-500/50 rounded-lg p-3.5 text-xs font-mono shadow-md">
                        ...
                        <div className="flex items-center justify-between pb-2 mb-2 border-b border-[#1E293B]">
                          <div className="flex items-center gap-2 text-emerald-300 font-bold">
                            ...
                            <span>
                              {answer.answerSource === 'gemini'
                                ? 'AI PROPOSED ANSWER (BEFORE DOM APPLY):'
                                : 'DETERMINISTIC FALLBACK (BEFORE DOM APPLY):'}
                            </span>
                          </div>
                        ...
                        <div className="flex items-start gap-2 text-slate-300">
                          ...
                          <div>
                            <span className="font-bold text-emerald-400">
                              {answer.answerSource === 'gemini' ? 'Gemini AI reasoning: ' : 'Fallback reasoning: '}
                            </span>
                                ...
                                <div className="flex flex-wrap gap-1.5 pt-0.5">
                                  {ans.selectedValues.map((val, vIdx) => (
                                    ...
                                    >
                                      ...
                                      <span>
                                        {ans.optionLabelsByValue?.[val] || val}
                                        <span className="ml-1 text-[10px] text-emerald-500/80">(value: {val})</span>
                                      </span>
                                    </span>
                                  ))}
                                </div>
